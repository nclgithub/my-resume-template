...
export default function ResumePDF() {
  ...
  return (
    <div className="flex-1 min-h-0 grid grid-cols-5 gap-8 p-6 bg-gray-100">
      {isOpenSectionModel && (
        <div
          ...
          <div className="relative p-4 w-fit h-fit max-w-full max-h-full">
            <div className="relative bg-white border border-default rounded-xl shadow-sm p-4 md:p-6 w-fit">
              ...
              <div className="grid gap-4 py-4 md:py-6 grid-cols-1 md:grid-cols-3 auto-rows-fr">
                <button
                  className="w-[500px] text-left border-2 rounded-lg hover:border-gray-500"
                  onClick={() => {
      ...
      <div className="flex flex-col bg-white p-6 shadow-md rounded-lg col-span-2 min-h-0">
        <div className="flex-1 mb-4 pl-2 pr-2 overflow-y-auto overflow-x-hidden">
          ...
          <div className="relative pt-8 pb-8 hrline-with-menu">
            ...
            <div className="float-menu flex items-center justify-between bg-white bg-opacity-80 backdrop-blur-md rounded-full px-2 py-3 shadow-lg w-fit mx-auto transition-all duration-300 hover:shadow-xl hover:bg-opacity-90">
              <button
                onClick={e => {
      ...
      <div className="relative col-span-3 min-h-0">
        ...
        <div className="absolute right-0 bottom-0 pr-8 pb-8">
          <button className="flex flex-wrap gap-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-3 rounded" onClick={() => setIsOpenSampleModel(true)}>
            <span className="mt-[1px]">Sample</span>
            <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" className="h-6 w-6" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round" xmlns="http://www.w3.org/2000/svg">
